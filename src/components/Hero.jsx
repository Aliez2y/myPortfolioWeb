...
const techStackLogo = [html, css, javascript, react, vite, tailwind, nodejs, postgres, github, vscode]
  ...
  return (
    <div className="bg-black min-h-full text-white pb-20">
      ...
      <div className="mt-20 text-center px-4">
         <h1 className="text-9xl font-bold tracking-tighter mb-6">
            Welcome to<br/> My website
         </h1>
         <p className="text-gray-400 text-xl mx-auto mt-15">
