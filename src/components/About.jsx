...
const skills = [
  ...
  "Node.js", "PostgreSQL", "Git", "GitHub", "VS Code"
]
    ...
    <div id="about" className='bg-black text-white py-20 flex justify-center'>
        ...
        <div className='container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-20'>
            ...
            <div className='order-2 md:order-1'> 
                ...
                {/* --- ส่วนแสดง Skills (New!) --- */}
                <div>
                    <h3 className="text-2xl font-semibold mb-8 border-l-4 border-purple-500 pl-3">My Tech Stack</h3>
            ...
            <div className='order-1 md:order-2 flex justify-center md:justify-end'>
                <div className="relative group">
                    ...
                    <img 
                        src={myImage} 
                        alt="Profile" 
                        className="relative w-72 h-72 md:w-150 md:h-180 object-cover rounded-2xl shadow-2xl ring-1 ring-white/10 grayscale group-hover:grayscale-0 transition duration-500" 
                    />
                </div>
            </div>
