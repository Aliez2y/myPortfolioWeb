...
function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Projects', label: 'Projects', count: 1 },
        ...
        {navLinks.map((link) => (
          ...
          >
            <div className="flex items-center gap-2">
              {link.name === 'Projects' && link.count && activeTab !== 'Projects' && (
                 <span className="bg-gray-700 text-[10px] text-white w-5 h-5 flex items-center justify-center rounded-full">
                   {link.count}
                 </span>
              )}
               {link.name === 'Projects' && link.count && activeTab === 'Projects' && (
                 <span className="bg-black text-[10px] text-white w-5 h-5 flex items-center justify-center rounded-full">
                   {link.count}
                 </span>
              )}
              {link.label}
